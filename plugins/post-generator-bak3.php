...
function mm_generate_posts()
{
    ...
    if (isset($_POST['category'], $_POST['titles'], $_POST['content'], $_POST['mm_selected_images'])) {
        ...
        $category_id = $category_obj ? $category_obj->term_id : 0;
...
function mm_list_categories_as_options()
{
    ...
    foreach ($categories as $category) {
        $options .= sprintf('<option value="%d">%s</option>', $category->term_id, $category->name);
    }
